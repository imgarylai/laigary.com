...
const EXT_LINK =
  "inline-flex min-h-6 min-w-6 items-center justify-center px-1 text-tm-muted no-underline hover:text-tm-accent";
...
export function TmFooter({ siteName, social }: { siteName: string; social: FooterSocial }) {
  ...
  return (
    <footer className="flex h-8 items-center justify-between gap-3 overflow-hidden whitespace-nowrap border-t border-tm-border bg-tm-subtle px-3.5 text-xs">
